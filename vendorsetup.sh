...
git clone https://github.com/Alucard-Storm/android_device_oneplus_sdm845-common.git -b lineage-23 device/oneplus/sdm845-common --depth=1

echo "cloning kernel"
git clone https://github.com/Alucard-Storm/android_kernel_oneplus_sdm845.git -b lineage-22.2 kernel/oneplus/sdm845 --depth=1 --recursive
...
git clone https://github.com/Alucard-Storm/proprietary_vendor_oneplus_sdm845-common.git -b lineage-23 vendor/oneplus/sdm845-common --depth=1
